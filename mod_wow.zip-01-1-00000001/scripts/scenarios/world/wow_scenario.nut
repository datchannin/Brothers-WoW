...
*/
		...
		item = this.new("scripts/items/staffs/firestaff");
		this.World.Assets.getStash().add(item);

		item = this.new("scripts/items/staffs/holystaff");
		this.World.Assets.getStash().add(item);
		...
		item = this.new("scripts/items/armor/hunter_t0_armor");
		this.World.Assets.getStash().add(item);
		...
		item = this.new("scripts/items/armor/rogue_t0_armor");
		this.World.Assets.getStash().add(item);

		item = this.new("scripts/items/helmets/rogue_t0_helmet");
		this.World.Assets.getStash().add(item);

		item = this.new("scripts/items/armor/paladin_t0_armor");
		this.World.Assets.getStash().add(item);

		item = this.new("scripts/items/helmets/paladin_t0_helmet");
		this.World.Assets.getStash().add(item);

		item = this.new("scripts/items/armor/warrior_t0_armor");
		this.World.Assets.getStash().add(item);
		...
		for (local i = 0; i < 3; i=++i)
		{
			...
			this.World.Assets.getStash().add(this.new("scripts/items/armor_upgrades/priest_t0_update"));
