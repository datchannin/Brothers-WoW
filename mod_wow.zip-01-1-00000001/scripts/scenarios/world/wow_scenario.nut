...
*/
		...
		*/
		...
		this.World.Assets.getStash().add(this.new("scripts/items/misc/wardog_armor_upgrade_item"));
		this.World.Assets.getStash().add(this.new("scripts/items/misc/wardog_armor_upgrade_item"));
		this.World.Assets.getStash().add(this.new("scripts/items/armor/warlock_t0_armor"));
		this.World.Assets.getStash().add(this.new("scripts/items/helmets/warlock_t0_helm"));
