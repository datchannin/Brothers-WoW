...
this.actor <- this.inherit("scripts/entity/tactical/entity", {
	...
	{
		return (this.m.CurrentProperties.ActionPoints * this.m.CurrentProperties.ActionPointsMult + this.m.CurrentProperties.ActionPointsBonus);
	}
	...
	function addDefaultStatusSprites()
	{
		...
		aura.Visible = false;
		local aura2 = this.addSprite("aura2");
		aura2.Visible = false;
		local aura3 = this.addSprite("aura3");
		aura3.Visible = false;
		local aura4 = this.addSprite("aura4");
		aura4.Visible = false;
