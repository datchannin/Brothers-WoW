...
this.gnoll_poacher <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		color = 2
	},
	function create()
	{
		this.m.Type = this.Const.EntityType.GnollPoacher;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.GnollPoacher.XP;
		...
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/gnoll_poacher_agent");
	...
	function assignRandomEquipment()
	{
		...
		this.m.Items.addToBag(this.new("scripts/items/weapons/gnolls/gnoll_mace"));
