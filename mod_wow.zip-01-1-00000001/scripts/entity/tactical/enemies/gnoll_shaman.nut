...
this.gnoll_shaman <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		color = 2
	},
	function create()
	{
		this.m.Type = this.Const.EntityType.GnollShaman;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.GnollShaman.XP;
