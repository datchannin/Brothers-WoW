...
this.gnoll_assassin <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		color = 2
	},
	function create()
	{
		this.m.Type = this.Const.EntityType.GnollAssassin;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.GnollAssassin.XP;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		if (_tile != null)
		{
			...
			corpse.CorpseName = "An Assassin Gnoll";
			corpse.Tile = _tile;
