...
this.perk_wow_curseofdoom <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "perk.wow.warlock.curseofdoom";
		this.m.Name = this.Const.Wow_strings.PerkName.CurseofDoom;
		this.m.Description = this.Const.Wow_strings.PerkDescription.CurseofDoom;
