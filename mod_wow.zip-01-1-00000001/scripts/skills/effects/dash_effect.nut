...
this.dash_effect <- this.inherit("scripts/skills/skill", {
	m = {
		BaseDuration = 1,
		TurnsLeft = 1
	},
	function create()
	{
		this.m.ID = "effects.dash";
		this.m.Name = "Dash";
		this.m.Icon = "ui/perks/perk_druid_dash.png";
		this.m.IconMini = "effect_mini_dash";
	...
	{
		return "This character is under \'Dash\' effect for [color=" + this.Const.UI.Color.PositiveValue + "]" + this.m.TurnsLeft + "[/color] more turn(s).";
	}
