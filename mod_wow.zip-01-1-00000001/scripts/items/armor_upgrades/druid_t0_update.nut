...
this.druid_t0_update <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.OverlayIcon = "armor_upgrades/icon_upgrade_wow_druid_shoulders_t0.png";
		this.m.OverlayIconLarge = "armor_upgrades/upgrade_inventory_wow_druid_shoulders_t0.png";
		this.m.SpriteFront = "upgrade_wow_druid_shoulders_t0";
		this.m.SpriteBack = null;
		this.m.SpriteDamagedFront = "upgrade_wow_druid_shoulders_t0_damaged";
		this.m.SpriteDamagedBack = null;
		this.m.SpriteCorpseFront = "upgrade_wow_druid_shoulders_t0_dead";
