...
this.ai_engage_cast <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		TargetTile = null,
		TargetScore = 0.0,
		ValidTargets = [],
	...
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.EngageCast;
		this.m.Order = this.Const.AI.Behavior.Order.EngageCast;
	...
	function onEvaluate( _entity )
	{
		...
		return (this.Const.AI.Behavior.Score.EngageCast + this.m.TargetScore) * scoreMult;
	}
