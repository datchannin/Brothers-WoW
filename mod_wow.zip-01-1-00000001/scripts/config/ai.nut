...
gt.Const.AI <- {
	...
	Agent = {
		ID = {
			...
			GnollMystic = "agent.gnoll.mystic",
			GnollShaman = "agent.gnoll.shaman",
			GnollPoacher = "agent.gnoll.ranged",
			GnollAssassin = "agent.gnoll.assassin",
			GnollBrute = "agent.gnoll.brute"
		},
		Intentions = {
