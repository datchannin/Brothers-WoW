...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Eviscerate = "Unlocks the \'Eviscerate\' skill which can be used for deal great direct damage if rogue is equipped by special Offhand dagger.\nAllows rogue to get \'Combo Points\' after he uses \'Slash\', \'Flail\', \'Puncture\' or \'Chop\' skills.",
	Fasttoxin = "Unlocks the \'Fast Toxin\' skill which consumes a Poison effect on an enemy target to instantly damage him an amount equal to summ of consumed coming Poison damage.",
	...
	DivineStrength = "You have skill in weapon using. This perk helps you to increase Melee Skill by [color=" + this.Const.UI.Color.PositiveValue + "]15[/color] points.",
	...
	BlastWave = "You understood how to use \'Fireball\' and \'Pyroblast\' more destructive. Increase range of \'Fireball\' and \'Pyroblast\' by [color=" + this.Const.UI.Color.PositiveValue + "]2[/color] and base damage by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color] points.",
	...
	MagicAbsorption = "You know how to increase efficiency of your damage spells and this ability reduces \'Frostbolt\' and \'Fireball\' Fatigue cost by [color=" + this.Const.UI.Color.PositiveValue + "]2[/color] and \'Pyroblast\' Fatigue cost by [color=" + this.Const.UI.Color.PositiveValue + "]8[/color].",
	MagicInstability = "Small lightning flies away from you when you are casting spells. Increase range of \'Frostbolt\', \'Pyroblast\' and \'Fireball\' by [color=" + this.Const.UI.Color.PositiveValue + "]1[/color].",
	FireAttunement = "Your fire spells are more destructive now, but you are worse at handling ice spells. Increase \'Fireball\' and \'Pyroblast\' base damage by [color=" + this.Const.UI.Color.PositiveValue + "]7[/color] points.\nDecrease \'Frostbolt\' base damage by [color=" + this.Const.UI.Color.NegativeValue + "]4[/color] points.",
	IceAttunement = "Your frost spells are more destructive now, but you are worse at handling fire spells. Increase \'Frostbolt\' base damage by [color=" + this.Const.UI.Color.PositiveValue + "]7[/color] points.\nDecrease \'Fireball\' and \'Pyroblast\' base damage by [color=" + this.Const.UI.Color.NegativeValue + "]4[/color] points.",
	...
	UnbreakableWill = "Legends are made about the unbreakable will of the priests, and now you are one of them! Reduces Fatigue cost of healing and repair spells by [color=" + this.Const.UI.Color.PositiveValue + "]8[/color] points.",
	...
	ElusiveProtection = "You know how to use armor, as well as dodge attacks as much as possible. Hitpoint damage taken is reduced by [color=" + this.Const.UI.Color.PositiveValue + "]15%[/color] if your total penalty to Maximum Fatigue from body and head armor is below [color=" + this.Const.UI.Color.PositiveValue + "]30[/color].\n\nArmor damage taken is reduced by the [color=" + this.Const.UI.Color.PositiveValue + "]15%[/color].\n\nBonus from this perk works always for armor damage taken, but hitpoints damage taken reducing will be nullified if total penalty to Maximum Fatigue from body and head armor is above [color=" + this.Const.UI.Color.PositiveValue + "]30[/color].",
	Hell = "A Hellish Aura envelops this creature, stay away from it!"
};