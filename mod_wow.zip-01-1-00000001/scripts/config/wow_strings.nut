...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Sprint = "Unlocks the \'Sprint\' skill which allows rogue to move faster. Action Point costs for movement on all terrain is [color=" + this.Const.UI.Color.PositiveValue + "]1[/color] point per tile. And fatigue cost now is [color=" + this.Const.UI.Color.PositiveValue + "]2[/color] points per tile.",
