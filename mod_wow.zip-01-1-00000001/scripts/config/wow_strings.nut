...
gt.Const.Wow_strings.PerkDescription <- {
	...
	RetributionAura = "Unlocks the \'Retribution Aura\' skill. This aura add Hitpoints regeneration of all party members within 4 tiles by [color=" + this.Const.UI.Color.PositiveValue + "]2[/color] points.",
	...
	SanctityAura = "Unlocks the \'Sanctity Aura\' skill. This aura allows all party members within 4 tiles to restore [color=" + this.Const.UI.Color.PositiveValue + "]4[/color] health by every successful melee attack.",
