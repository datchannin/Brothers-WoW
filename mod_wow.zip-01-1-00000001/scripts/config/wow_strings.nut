...
gt.Const.Wow_strings.PerkDescription <- {
	...
	LightAura = "Unlocks the \'Light Aura\' skill. This aura add Hitpoints regeneration of all party members within 4 tiles by [color=" + this.Const.UI.Color.PositiveValue + "]2[/color] points.",
