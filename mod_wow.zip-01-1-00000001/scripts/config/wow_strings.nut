...
gt.Const.Wow_strings.PerkDescription <- {
	...
	PetCare = "You are really know how to care your pet! Increases base heal power of the \'Mend Pet\' skill by [color=" + this.Const.UI.Color.PositiveValue + "]20[/color] points.\nAlso Action Points cost of this spell will be reduced by [color=" + this.Const.UI.Color.PositiveValue + "]1[/color].",
