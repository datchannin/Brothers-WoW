...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Endurance = "Drop the shield and don\'t think about the defense. This perk help you to increase Melee Defense by [color=" + this.Const.UI.Color.PositiveValue + "]10[/color] points. Your Initiative will be also increased by [color=" + this.Const.UI.Color.PositiveValue + "]10[/color] points.",
