...
gt.Const.Wow_strings.PerkDescription <- {
	...
	FireAttunement = "Your fire spells are more destructive now. Increase \'Fireball\' base damage by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color] points.",
	IceAttunement = "Your frost spells are more destructive now. Increase \'Frostbolt\' base damage by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color] points.",
