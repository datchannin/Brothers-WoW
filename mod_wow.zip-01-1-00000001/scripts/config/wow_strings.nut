...
gt.Const.Wow_strings.PerkDescription <- {
	...
	BestialSwiftness = "Step to train your pet. Now Winter Wolf has more Fatigue Recovery and Action Points. This perk help you to increase your pet Fatigue Recovery by [color=" + this.Const.UI.Color.PositiveValue + "]10[/color] points. Pet Action Points also increases by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color]. The effect is growing with your level.",
