...
gt.Const.Wow_strings.PerkDescription <- {
	...
	ThickHide = "Step to train your pet. Now Winter Wolf has more Armor. This perk help you to increase your pet Armor by [color=" + this.Const.UI.Color.PositiveValue + "]40[/color] points.",
