...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Cleanse = "You have a knowledge in bleeding cleanse. This enhances your [color=" + this.Const.UI.Color.PositiveValue + "]\'Holy Light\'[/color] skill with possibility to remove [color=" + this.Const.UI.Color.PositiveValue + "]\'Bleed\'[/color] effect from target. Does not have any effect if you don\'t have [color=" + this.Const.UI.Color.PositiveValue + "]\'Holy Light\'[/color] skill.",
