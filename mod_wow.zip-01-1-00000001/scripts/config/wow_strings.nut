...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Survivalist = "Do you know how stay alive? Increase your Hitpoints and win the combat. Hitpoints are increased by [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color]",
	...
	BestialSwifting = "Step to train your pet. Now Winter Wolf has more Fatigue Recovery and Action Points. This perk help you to increase your pet Fatigue Recovery by [color=" + this.Const.UI.Color.PositiveValue + "]10[/color] points. Pet Action Points also increases by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color].",
	...
	AspectoftheMonkey = "You know how Monkey dodges hits. Increase your pet Range Defense by [color=" + this.Const.UI.Color.PositiveValue + "]20[/color] points",
