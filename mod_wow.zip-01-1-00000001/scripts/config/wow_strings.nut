...
gt.Const.Wow_strings.PerkDescription <- {
	...
	Pyroblast = "Unlocks the \'Pyroblast\' skill which allows mage to deal massive fire damage. Target should be under \'Ignite\' effect in order to allow the mage to choose himself as a target.\nSpell damage is growing with your level.",
